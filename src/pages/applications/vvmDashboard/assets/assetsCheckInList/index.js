...
import styles from '../../../../../../styles/assetsCheckInList.module.css'
  ...
  return (
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/assets/assetsCheckInList'>
          <Typography className={styles.link} variant='subtitle'>{`${t('AssetsCheckInList')}`}</Typography>
        </Link>
      </Breadcrumbs>
...
export default AssetsCheckInList
