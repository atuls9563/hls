...
import styles from '../../../../../styles/vvmTrailer.module.css'
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/vvmTrailer'>
          <Typography variant='subtitle' className={styles.link}>{`${t('Trailers')}`}</Typography>
        </Link>
      </Breadcrumbs>
      <Grid container className={styles.container}>
        ...
        <Grid item xs={12} md={12}>
          <Grid container className={styles.block} justifyContent='space-between'>
            ...
            <Grid item xs={12} md={2.9} className={styles.box}>
              <Card variant='outlined' className={styles.contentCard}>
                <Link href='/applications/vvmDashboard/vvmTrailer/yardInventory'>
                  <Grid item xs={12} md={12} className={styles.box}>
                    <Typography variant='subtitles2' className={styles.headingTwo}>
                      {`${t('Yard Inventory')}`}
                    </Typography>
          ...
          <Grid container className={styles.blockOne} columnGap={4}>
            <Grid item xs={12} md={2.9} className={styles.box}>
              <Card variant='outlined' className={styles.contentCard}>
                <Link href='/applications/vvmDashboard/vvmTrailer/trailersInspection'>
                  <Grid item xs={12} md={12} className={styles.box}>
                    <Typography variant='subtitles2' className={styles.headingTwo}>
                      {`${t('Trailer Inspection')}`}
                    </Typography>
                  </Grid>
                </Link>
              </Card>
