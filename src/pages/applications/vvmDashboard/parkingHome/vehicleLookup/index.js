...
import styles from '../../../../../../styles/vehiclelookup.module.css'
  ...
  const columns = [
    {
      ...
      renderCell: props => {
        return (
          <>
            <Typography className={styles.link} variant='subtitle'>{`${t('Add Parking Violation')}`}</Typography>
          </>
        )
      }
    },
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/parkingHome'>
          <Typography variant='subtitle' className={styles.link}>{`${t('Parking Home')}`}</Typography>
        </Link>
        <Link href='/applications/vvmDashboard/vehiclelookup'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Vehicle Lookup')}`}</Typography>
        </Link>
      </Breadcrumbs>
                          ...
                          <Grid container>
                            ...
                            <Grid item xs={12} md={12}>
                              <Select size='small' variant='outlined' fullWidth>
                                <MenuItem value='vehicleLicense'>Vehicle License</MenuItem>
                              </Select>
                            </Grid>
                          </Grid>
                        </Grid>
