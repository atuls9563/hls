...
import styles from '../../../../../styles/addShiftAttributes.module.css'

const AddShiftAttributes = ({ openEdit, setOpenEdit, handleEditClickOpen, handleEditClose }) => {
...
export default AddShiftAttributes
