...
import styles from '../../../../../styles/trailerCheckOut.module.css'
import { useTranslation } from 'react-i18next'
import Link from 'next/link'
import { ChevronDown } from 'mdi-material-ui'
import Scan from '../scan'

const TrailerCheckOut = () => {
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/viewTrailerCheckIn/trailerCheckOut'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Trailer Check-Out')}`}</Typography>
        </Link>
      </Breadcrumbs>
...
export default TrailerCheckOut
