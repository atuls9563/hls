...
import { Fab, Grid,  Paper,  Typography,Divider } from '@mui/material'
...
const OrderDetailsModal = ({ openEditTwo, setOpenEditTwo, handleEditClickOpenTwo, handleEditCloseTwo }) => {
        ...
        <Paper className={styles.modal} variant='outlined'>
          <Grid container className={styles.container} justifyContent='space-between'>
            ...
            <Grid item xs={12} md={6} className={styles.headerRight}>
              ...
              <Fab color='secondary'onClick={handleEditCloseTwo} variant='extended' size='medium' type='submit' className={styles.button}>
                {`${t('Close')}`}
              </Fab>
            </Grid>
