...
import styles from '../../../../../styles/editDistributionAAT.module.css'

const EditDistributionAAT = ({ openEditThree, setOpenEditThree, handleEditClickOpenThree, handleEditCloseThree }) => {
...
export default EditDistributionAAT
