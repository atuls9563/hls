...
import styles from '../../../../../styles/addCSM.module.css'
import React from 'react'
import { TextField, Grid, Paper, Select, MenuItem } from '@mui/material'
import { useTranslation } from 'react-i18next'

const AddCSM = ({ openEdit, setOpenEdit, handleEditClickOpen, handleEditClose }) => {
          ...
          <Grid container className={styles.container}>
            ...
            <Grid item xs={12} md={12} className={styles.headingTwo}>
              <Typography variant='subtitle2' >
                {`${t(
                  'To add a CSM , you must add a title - you can do it by doing one of the following way. Use employee search if you are not sure of the title.'
                )}`}
              </Typography>
            </Grid>
            <Grid item xs={12} md={12}>
