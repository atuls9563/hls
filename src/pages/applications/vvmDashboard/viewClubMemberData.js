...
import styles from '../../../../styles/viewClubMemberData.module.css'
...
const ViewClubMemberData = () => {
  ...
  const columns = [
    {
      flex: 0.01,
      field: 'clubMemberName',
      headerName: 'Club Member Name',
      minWidth: 80,
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/viewClubMemberData'>
          <Typography className={styles.link} variant='subtitle'>{`${t('View Club Member Data')}`}</Typography>
        </Link>
      </Breadcrumbs>
...
export default ViewClubMemberData
