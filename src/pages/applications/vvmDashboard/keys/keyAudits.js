...
import styles from '../../../../../styles/keyAudits.module.css'
...
const KeyAudits = () => {
  ...
  const columns = [
    ...
    {
      flex: 0.01,
      field: 'totalKeysFound',
      headerName: 'Total Keys Found',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
  ...
  return (
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/keys/keyAudit'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Key Audits')}`}</Typography>
        </Link>
      </Breadcrumbs>
