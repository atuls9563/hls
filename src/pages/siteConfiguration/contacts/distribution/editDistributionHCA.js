...
import styles from '../../../../../styles/editDistributionHCA.module.css'

const EditDistributionHCA = ({ openEditFive, setOpenEditFive, handleEditClickOpenFive, handleEditCloseFive }) => {
  ...
  return (
    <div>
      <Modal open={openEditFive} onClose={handleEditCloseFive}>
        <Paper className={styles.modal} variant='outlined'>
          <Grid container className={styles.container} columnGap={2}>
            <Grid item xs={12} md={12} className={styles.header}>
              ...
              <Close onClick={handleEditCloseFive} className={styles.icon} />
            </Grid>
            ...
            <Grid item xs={12} md={12}>
              ...
              <Typography variant='subtitle2' className={styles.headingTwo}>
                <b>{`${t('HCA Tier 1000015,HCA Tier 1000003,HCA Tier 1000013,HCA Tier 1000009,HCA Tier 1000007,HCA Tier 1000004,HCA Tier 1000014,HCA Tier 1000010,HCA Tier 1000008,HCA Tier 1000005,HCA Tier 1000011,HCA Tier 1000006,HCA Tier 14485')}`}</b>
              </Typography>
            </Grid>
            <Grid item xs={12} md={12}>
              <Divider />
...
export default EditDistributionHCA
