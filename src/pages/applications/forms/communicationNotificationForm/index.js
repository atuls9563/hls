...
import styles from '../../../../../styles/communicationNotificationForm.module.css'
...
const CommunicationNotificationForm = () => {
  ...
  const columns = [
    ...
    {
      flex: 0.01,
      field: 'whoNotifiedYou',
      headerName: 'Who notified you?',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
      flex: 0.01,
      field: 'howWereYouNotified',
      headerName: 'How were you notified?',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
      flex: 0.01,
      field: 'whatIs/WasTheMessageOrInfraction',
      headerName: 'What is/was the message or infraction?',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
      flex: 0.01,
      field: 'whoDidYouNotify',
      headerName: 'Who did you notify?',
      minWidth: 80,
      sortable: isNameSortable,
      renderCell: props => {
        return <Eye />
...
export default CommunicationNotificationForm
