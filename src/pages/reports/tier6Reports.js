...
import styles from '../../../styles/tier6Reports.module.css'
  ...
  return (
    <>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/reports/tier6Reports'>
          <Typography variant='subtitle' className={styles.link}>{`${t('Tier 6 Reports')}`}</Typography>
        </Link>
      </Breadcrumbs>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Grid container className={styles.header}>
            ...
            <Grid item xs={12} md={3} className={styles.heading3}>
              <Typography variant='subtitle2' className={styles.heading}>
                {`${t('Select Client Tier 6')}`} <span className={styles.aster}>*</span>
              </Typography>
            </Grid>
            <Grid item xs={12} md={2.5}>
              <TextField fullWidth size='small' placeholder={`${t('Search a Tier')}`} />
            </Grid>
          </Grid>
