...
import styles from '../../../../../../styles/heliausInboundForm.module.css'
import { useTranslation } from 'react-i18next'
import Link from 'next/link'
import { ChevronDown } from 'mdi-material-ui'
import Scan from '../../scan'

const HeliausInboundForm = () => {
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/customInOutForms/heliausSiteCustomInOutForm/heliausInboundForm'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Heliaus Inbound Form')}`}</Typography>
        </Link>
      </Breadcrumbs>
            ...
            <Grid container>
              ...
              <Grid item xs={12} md={12}>
                <Typography variant='subtitle2' className={styles.asterTwo}>
                  {`${t(
                    'Note: Current global site(Heliaus Test Site V2 (1106661) - #1106661) is used for the Heliaus Inbound Form.'
                  )}`}
                </Typography>
              </Grid>
              <Grid item xs={12} md={12}>
...
export default HeliausInboundForm
