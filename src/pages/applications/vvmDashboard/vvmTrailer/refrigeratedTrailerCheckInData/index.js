...
import styles from '../../../../../../styles/refrigeratedTrailerCheckInData.module.css'
...
const RefrigeratedTrailerCheckInData = () => {
  ...
  const columns = [
    ...
    {
      flex: 0.01,
      field: 'trailerLicense',
      headerName: 'Trailer License No.',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
      flex: 0.01,
      field: 'physicalSeal',
      headerName: 'Physical Seal Number',
      minWidth: 80,
      sortable: isNameSortable
    }
  ]
        ...
        <Grid container className={styles.container}>
          <Grid item xs={12} md={3.9}>
            <Typography variant='h6' className={styles.topHeading}>
              {`${t('Refrigerated Trailer Check-In Data')}`}
            </Typography>
          </Grid>
          <Grid item xs={12} md={3}>
            <Link href='/applications/vvmDashboard/vvmTrailer/refrigeratedTrailerCheckInData/refrigeratedTrailerCheckIn'>
              <Fab color='secondary' variant='extended' size='medium' type='submit' className={styles.button}>
                {`${t('Check In a Refrigerated Trailer')}`}
              </Fab>
            </Link>
          </Grid>
...
export default RefrigeratedTrailerCheckInData
