  ...
  return (
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/vvmTrailer/trailersInspection/inspection'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Trailer Inspection')}`}</Typography>
        </Link>
      </Breadcrumbs>
                ...
                <Grid container className={styles.textField} justifyContent='space-between'>
                  ...
                  <Grid item xs={12} md={3.9}>
                    <Grid container>
                      ...
                      <Grid item xs={12} md={12}>
                        <Typography variant='subtitle2'>
                          <Radio color='secondary' /> {`${t('Yes')}`} <Radio color='secondary' />
                          {`${t('No')}`}
                        </Typography>
                      </Grid>
                    </Grid>
                    ...
                    <Grid container>
                      ...
                      <Grid item xs={12} md={12}>
                        <Select size='small' fullWidth>
                          <MenuItem value='selectFuel'>Select Fuel</MenuItem>
                        </Select>
                      </Grid>
                    </Grid>
                  </Grid>
