...
import styles from '../../../../../../styles/viewYardInventory.module.css'
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/vvmTrailer/yardInventory'>
          <Typography className={styles.link} variant='subtitle'>{`${t('View Yard Inventory')}`}</Typography>
        </Link>
      </Breadcrumbs>
      <Paper variant='outlined'>
        <Grid container className={styles.container}>
          ...
          <Grid item xs={12} md={3.9}>
            ...
            <Link href='/applications/vvmDashboard/viewYardInventory/YardInventory'>
              <Fab color='secondary' variant='extended' size='medium' type='submit' className={styles.button}>
                {`${t('Deactivate')}`}
              </Fab>
            </Link>
...
export default ViewYardInventory
