...
import styles from '../../../../../styles/editDistributionHCACTM.module.css'

const EditDistributionHCACTM = ({ openEditSix, setOpenEditSix, handleEditClickOpenSix, handleEditCloseSix }) => {
  ...
  return (
    <div>
      <Modal open={openEditSix} onClose={handleEditCloseSix}>
        <Paper className={styles.modal} variant='outlined'>
          <Grid container className={styles.container} columnGap={2}>
            <Grid item xs={12} md={12} className={styles.header}>
              ...
              <Close onClick={handleEditCloseSix} className={styles.icon} />
            </Grid>
            ...
            <Grid item xs={12} md={12} className={styles.content}>
              ...
              <Typography variant='subtitle2' className={styles.headingSix}>
            ...
            <Grid item xs={12} md={3.9}>
              <Typography variant='subtitle2' className={styles.headingTwo}>
                <EmailOutline className={toggle ? styles.icon : styles.iconTwo} onClick={e => toggleIt(e)} />
                {`${t('Road Test for Cart Operations Checklist (Form submission)')}`}
              </Typography>
            </Grid>
            <Grid item xs={12} md={3.9}>
              <Typography variant='subtitle2' className={styles.headingTwo}>
                <EmailOutline className={toggle ? styles.icon : styles.iconTwo} onClick={e => toggleIt(e)} />
                {`${t('Road Test for Cart Operations Checklist (Last 24 Hours CSV)')}`}
              </Typography>
            </Grid>
            <Grid item xs={12} md={12}>
              <Divider />
            ...
            <Grid item xs={12} md={12}>
              ...
              <Typography variant='subtitle2' className={styles.headingTwo}>
                <strong>{`${t('HCA Monthly Tier 13 Report')}`}</strong>
              </Typography>
            </Grid>
            <Grid item xs={12} md={12}>
              <Divider />
...
export default EditDistributionHCACTM
