...
import styles from '../../../../../styles/cameraDisableTestForm.module.css'
...
const CameraDisableTestForm = () => {
  ...
  const columns = [
    ...
    {
      flex: 0.01,
      field: 'isRadioWorking',
      headerName: 'Is Radio Working',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
    ...
    {
      flex: 0.01,
      field: 'isDoorUnlocked',
      headerName: 'Is Door Unlocked',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
      flex: 0.01,
      field: 'isCameraIntercomavailable',
      headerName: 'Is Camera Intercom Available',
      minWidth: 80,
      sortable: isNameSortable
    }
  ]
...
export default CameraDisableTestForm
