...
import { Checkbox, Fab, Grid, Paper, Radio, TextField } from '@mui/material'
import { useTranslation } from 'react-i18next'
import styles from '../../../../../styles/personDetailsEdit.module.css'
import MuiPhoneNumber from 'material-ui-phone-number-2'
import Image from 'next/image'
import ImageUploading from 'react-images-uploading'


const PersonDetailsEdit = ({ openEditTwo, setOpenEditTwo, handleEditClickOpenTwo, handleEditCloseTwo ,notify}) => {
        ...
        <Paper className={styles.modal} variant='outlined'>
          <Grid container className={styles.container} columnGap={2}>
            ...
            <Grid item xs={12} md={3.9}>
              ...
              <Typography variant='caption' className={styles.headingThree}>
                {`${t('or')}`}
              </Typography>
            ...
            <Grid item xs={12} md={3.9}>
              ...
              <TextField
                ...
                rows={2}
                multiline
                placeholder={`${t('This is for test purpose, please ignore')}`}
              />
            </Grid>
            <Grid item xs={12} md={12} className={styles.footer}>
              <Fab color='secondary' variant='extended' size='medium' type='submit' className={styles.button2} onClick={() => { notify(); handleEditCloseTwo();}}>
                {`${t('Update')}`}
              </Fab>
              <Fab
                color='secondary'
