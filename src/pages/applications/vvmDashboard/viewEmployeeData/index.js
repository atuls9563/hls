...
import styles from '../../../../../styles/viewEmployeeData.module.css'
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/viewEmployeeData'>
          <Typography className={styles.link} variant='subtitle'>{`${t('View Employee Data')}`}</Typography>
        </Link>
      </Breadcrumbs>
