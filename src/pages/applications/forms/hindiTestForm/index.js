...
import styles from '../../../../../styles/hindiTestForm.module.css'
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position='start'>
                    ...
                    <Divider
                     orientation='vertical' className={styles.divider3} />
                  </InputAdornment>
                ),
                endAdornment: (
