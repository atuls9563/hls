...
import styles from '../../../../../styles/trailersActivateData.module.css'
    ...
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/viewTrailerCheckIn'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Trailer Home')}`}</Typography>
        </Link>
        <Link href='/applications/vvmDashboard/viewTrailerCheckIn/trailersActivateData'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Trailers Activate Data')}`}</Typography>
        </Link>
      </Breadcrumbs>
...
export default TrailersActivateData
