...
import styles from '../../../../../styles/removeCommisionedRecipientsTitle.module.css'
import React from 'react'
import { Checkbox, Grid, Paper } from '@mui/material'
import { useTranslation } from 'react-i18next'

const RemoveCommisionedRecipientsTitle = ({ openEditTwo, setOpenEditTwo, handleEditClickOpenTwo, handleEditCloseTwo }) => {
          ...
          <Grid container className={styles.container}>
            <Grid item xs={12} md={12} className={styles.header}>
              <Typography variant='h5' className={styles.heading}>
                {`${t('Remove Commission Recipient Title')}`}
              </Typography>
...
export default RemoveCommisionedRecipientsTitle
