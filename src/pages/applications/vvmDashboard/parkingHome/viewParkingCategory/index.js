...
import styles from '../../../../../../styles/viewParkingCategory.module.css'
...
const ViewParkingCategory = () => {
  ...
  const columns = [
    ...
    {
      flex: 0.01,
      field: 'onParkingTicket',
      headerName: 'On Parking Ticket',
      minWidth: 80,
      sortable: isNameSortable,
      renderCell: props => {
        return (
  ...
  return (
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/parkingHome/viewParkingCategory'>
          <Typography className={styles.link} variant='subtitle'>{`${t('View Parking Category')}`}</Typography>
        </Link>
      </Breadcrumbs>
        ...
        <Grid container className={styles.container}>
          <Grid item xs={12} md={7.2}>
            <Typography variant='h5' className={styles.topHeading}>
              {`${t('View Parking Category')}`}
            </Typography>
          </Grid>
          <ToastContainer position='top-right' closeOnClick autoClose={5000}></ToastContainer>
...
export default ViewParkingCategory
