...
import styles from '../../../../../styles/jsaAcknowledgement.module.css'
...
const JSAAcknowledgement = () => {
  ...
  const columns = [
    ...
    {
      flex: 0.01,
      field: 'securityProfessionalName',
      headerName: 'Security Professional"s Name',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
    ...
    {
      flex: 0.01,
      field: 'client/WorksiteName',
      headerName: 'Client / Worksite Name',
      minWidth: 80,
      sortable: isNameSortable
    },
    {
        flex: 0.01,
        field: 'client/WorksiteAddress',
        headerName: 'Client / Worksite Address',
        minWidth: 80,
        sortable: isNameSortable
      }
  ]
...
export default JSAAcknowledgement
