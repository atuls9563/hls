...
import styles from '../../../../../../styles/vehicleSafeList.module.css'
import { DataGrid } from '@mui/x-data-grid'
import { ChevronDown, Eye, Magnify } from 'mdi-material-ui'
import Link from 'next/link'
import { useTranslation } from 'react-i18next'
import VehicleSafeListDetails from './vehicleSafeListDetails'

const VehicleSafeList = () => {
  ...
  return (
    <div>
      <Breadcrumbs className={styles.breadcrumb}>
        ...
        <Link href='/applications/vvmDashboard/parkingHome/vehicleSafeList'>
          <Typography className={styles.link} variant='subtitle'>{`${t('Vehicle Safe List')}`}</Typography>
        </Link>
      </Breadcrumbs>
...
export default VehicleSafeList
